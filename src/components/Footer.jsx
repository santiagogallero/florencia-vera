...
export default function Footer() {
  return (
    <footer className="relative bg-ink border-t border-white/[0.05] pt-16 pb-8 px-6 md:px-10 overflow-hidden">

      {/* Top gradient line */}
      <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-blue/40 to-transparent" />

      <div className="max-w-7xl mx-auto">

        {/* Top grid */}
        <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-12 pb-12 border-b border-white/[0.06]">
            ...
            <div className="flex gap-2.5">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-lg border border-white/[0.07] flex items-center justify-center text-white/35 hover:text-blue hover:border-blue/40 hover:bg-blue/[0.07] transition-all duration-200"
                >
                  <Icon />
                </a>
              ))}
          ...
          {/* Nav col */}
          <div>
            <h4 className="font-condensed font-bold text-[0.7rem] tracking-[0.2em] uppercase text-white/30 mb-5">
              Navegación
            </h4>
            <ul className="flex flex-col gap-3">
              {NAV.map(({ label, href }) => (
                <li key={label}>
                  <a
                    href={href}
                    className="font-barlow text-[0.88rem] text-white/55 hover:text-white transition-colors duration-200"
                  >
                    {label}
                  </a>
                </li>
        ...
        <div className="pt-6 flex flex-wrap items-center justify-between gap-3">
          <p className="font-barlow text-[0.76rem] text-white/25">
            © 2025 Florencia Vera. Todos los derechos reservados.
          </p>
          <p className="font-barlow text-[0.76rem] text-white/20">
